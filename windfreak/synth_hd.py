...
class SynthHDChannel:
    ...
    @property
    def sweep_type(self):
        """Get output sweep type
        """
        return self.read('sweep_type')
    
    @sweep_type.setter
    def sweep_type(self, value):
        """Set output sweep type.
        ...
        self.write('sweep_type', value)
            
    @property
    def sweep_list(self):
        """Get the current sweep list stored on the device.

        Returns:
            bool: enable
        """
        return self.read('sweep_list')

    @sweep_list.setter
    def sweep_list(self, value):
        """Set the sweep list.
        ...
        self.write('sweep_list', value)

    @property
    def sweep_single(self):
        """Get the current sweep_single stored on the device.

        Returns:
            str: sweep on device
        """
        return self.read('sweep_single')

    @sweep_single.setter
    def sweep_single(self, value):
        """Set the sweep_single.

        Args:
            value (int): enable
                x=1=start, restart or continue 
                x=0=pause
        """
        if not isinstance(value, int):
            raise ValueError('Expected int.')
        self.write('sweep_single', value)
    ...
    def sweep_direction(self):
        ...
        Returns:
            str: sweep on device
        """
        return self.read('sweep_direction')

    @sweep_direction.setter
    def sweep_direction(self, value):
        """Set the sweep_direction.
        ...
        if not isinstance(value, int):
            raise ValueError('Expected int.')
        self.write('sweep_direction', value)
...
class SynthHD(SerialDevice, Sequence):
    ...
    API = {
        ...
        'sweep_cont':       (bool,  'c{}',     'c?'),
        'sweep_list':       (str,   'Ld{}',    'L?'),  # Delete the stored list and replace it with a new list command
